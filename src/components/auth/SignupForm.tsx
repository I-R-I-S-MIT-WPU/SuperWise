...
export function SignupForm({ onSignupSuccess, onCancel }: SignupFormProps) {
  ...
  const conversationSteps: ConversationStep[] = [
    ...
    },
    {
      id: "username",
      question:
        "What's your email address? This will be used as your username.",
      field: "username",
      type: "text",
    ...
    },
    {
      id: "annual_income",
      question:
        "What's your annual income? (You can say something like '$75,000' or '75k')",
      field: "annual_income",
      type: "number",
    ...
    },
    {
      id: "current_savings",
      question:
        "How much do you currently have saved? (Include all your savings and investments)",
    ...
    },
    {
      ...
      question:
        "How much would you like to contribute monthly to your superannuation?",
    ...
    },
    {
      id: "risk_tolerance",
      question:
        "What's your risk tolerance for investments? Are you conservative (low risk), balanced (medium risk), or aggressive (high risk)?",
    ...
    },
    {
      ...
      question:
        "How many dependents do you have? (children or others you financially support)",
    ...
    },
    {
      ...
      question:
        "How many years have you been contributing to your superannuation?",
    ...
    },
    {
      id: "savings_rate",
      question:
        "What percentage of your income do you typically save? (e.g., '15%' or '15')",
      field: "savings_rate",
      type: "number",
    ...
    },
    {
      id: "monthly_expenses",
      question:
        "What are your average monthly expenses? (You can say something like '$2,500' or '2.5k')",
    ...
    },
    {
      id: "password",
      question:
        "Finally, create a password for your account (at least 6 characters):",
      field: "password",
      type: "text",
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      ...
      type: "bot",
      message:
        "Hi! I'm here to help you set up your superannuation profile. I'll ask you a few questions to get everything set up perfectly for you. Let's get started!",
      timestamp: new Date(),
    },
    {
      id: "2",
  ...
  const [currentPlayingMessage, setCurrentPlayingMessage] = useState<
    string | null
  >(null);
    ...
    try {
      ...
      if (data.enabled) {
        ...
        toast({
          ...
          description:
            "Azure Speech Services are not configured. Text-only mode enabled.",
          variant: "destructive",
        });
      }
    } catch (error) {
        ...
        if (voiceGuidedMode && currentStepIndex < conversationSteps.length) {
          ...
          if (extractedValue !== null && extractedValue !== undefined) {
            if (
              ...
              !currentStep.validation(extractedValue)
            ) {
            ...
            setFormData((prev) => ({
              ...prev,
              [currentStep.field]: extractedValue,
            }));
    ...
    setChatMessages([
      {
        ...
        type: "bot",
        message:
          "Hi! I'm here to help you set up your superannuation profile with voice assistance. I'll ask you questions one by one, and you can speak your answers. Let's get started!",
        timestamp: new Date(),
      },
      {
        id: "2",
  ...
  const parseUserInputWithLLM = async (
    input: string,
...
- For gender: {"value": "Male"}`;
  ...
  const moveToNextStep = () => {
    if (currentStepIndex < conversationSteps.length - 1) {
      ...
      const completionMessage: ChatMessage = {
        ...
        type: "bot",
        message:
          "Perfect! I've gathered all your information. You can review and modify any details in the form on the right, then click 'Create Account' to finish setting up your profile and see your retirement projections!",
        timestamp: new Date(),
      };
  ...
  const handleChatSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!chatInput.trim() || currentStepIndex >= conversationSteps.length)
      return;
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        ...
        type: "bot",
        message:
          "I had trouble understanding that. Could you please try rephrasing your answer?",
        timestamp: new Date(),
      };
      setChatMessages((prev) => [...prev, errorMessage]);
    } finally {
  ...
  const projectionData = useMemo(() => {
    ...
    const yearsToRetirement =
      calculatorInputs.retirementAge - calculatorInputs.currentAge;
    ...
    for (let i = 0; i <= yearsToRetirement; i++) {
      ...
      const investmentReturn =
        balance * (calculatorInputs.annualReturnRate / 100);
  ...
  const retirementAnalysis = useMemo((): RetirementAnalysis => {
    ...
    const totalRetirementNeeds =
      calculatorInputs.yearlyWithdrawal * yearsOfWithdrawal;

    const inflationAdjustedNeeds =
      calculatorInputs.yearlyWithdrawal /
      Math.pow(
        1 + calculatorInputs.inflationRate / 100,
        calculatorInputs.retirementAge - calculatorInputs.currentAge,
      );
  ...
  const balanceBreakdown = [
    {
      ...
      value: retirementAnalysis.totalContributions,
      color: "#3b82f6",
    },
    {
      name: "Investment Growth",
      value: retirementAnalysis.investmentGrowth,
      color: "#10b981",
    },
  ];
            ...
            <div className='lg:col-span-1 space-y-4'>
              <Card>
                ...
                <CardContent className='space-y-6'>
                  <div>
                    <Label>
                      Retirement Age: {calculatorInputs.retirementAge} years
                    </Label>
                    <Slider
                      value={[calculatorInputs.retirementAge]}
                      onValueChange={([value]) =>
                        handleCalculatorInputChange("retirementAge", value)
                      }
                      min={50}
                      max={80}
                      step={1}
                  ...
                  <div>
                    <Label>
                      ...
                      {formatCurrency(calculatorInputs.monthlyContribution)}
                    </Label>
                    <Slider
                  ...
                  <div>
                    <Label>
                      Expected Return:{" "}
                      {formatPercent(calculatorInputs.annualReturnRate)}
                    </Label>
                    <Slider
                      value={[calculatorInputs.annualReturnRate]}
                      onValueChange={([value]) =>
                        handleCalculatorInputChange("annualReturnRate", value)
                      }
                      min={3}
                      max={15}
                      step={0.5}
                  ...
                  <div>
                    <Label>
                      ...
                      {formatCurrency(calculatorInputs.yearlyWithdrawal)}
                    </Label>
                    <Slider
                      value={[calculatorInputs.yearlyWithdrawal]}
                      onValueChange={([value]) =>
                        handleCalculatorInputChange("yearlyWithdrawal", value)
                      }
                      min={30000}
                      max={150000}
                      step={5000}
            ...
            <div className='lg:col-span-2 space-y-6'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <Card>
                  <CardContent className='p-6 text-center'>
                    <div
                      className={`text-3xl font-bold mb-2 ${retirementAnalysis.shortfall > 0 ? "text-red-600" : "text-green-600"}`}>
                  ...
                  <CardContent>
                    <div className='space-y-4'>
                      ...
                      <div className='flex justify-between'>
                        ...
                        <span className='font-semibold'>
                          {formatCurrency(
                            retirementAnalysis.totalContributions,
                          )}
                        </span>
                      </div>
                      <div className='flex justify-between'>
                        ...
                        <span className='font-semibold text-green-600'>
                          {formatCurrency(retirementAnalysis.investmentGrowth)}
                        </span>
                      </div>
                      <div className='flex justify-between'>
                    ...
                    {retirementAnalysis.shortfall > 0 ? (
                      <div className='bg-red-50 border border-red-200 rounded-lg p-4'>
                        ...
                        <p className='text-red-700 mb-3'>
                          ...
                          {formatCurrency(retirementAnalysis.shortfall)}. Here
                          are some ways to improve your retirement outlook:
                        </p>
                        <ul className='list-disc list-inside space-y-1 text-red-700 text-sm'>
                          <li>
                            Consider increasing your monthly contributions by $
                            {Math.round(
                              retirementAnalysis.shortfall /
                                ((calculatorInputs.retirementAge -
                                  calculatorInputs.currentAge) *
                                  12),
                            )}
                          ...
                          <li>
                            Extend your retirement age by 2-3 years if possible
                          </li>
                          <li>
                            Review your investment strategy - higher risk
                            tolerance could increase returns
                          </li>
                          <li>
                            Consider additional income streams during retirement
                          </li>
                        </ul>
                      </div>
                    ) : (
                      <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                        ...
                        <p className='text-green-700 mb-3'>
                          You're on track for a comfortable retirement. Consider
                          these optimization strategies:
                        </p>
                        <ul className='list-disc list-inside space-y-1 text-green-700 text-sm'>
                          <li>
                            Review your portfolio annually to ensure it matches
                            your risk tolerance
                          </li>
                          <li>Consider salary sacrificing for tax benefits</li>
                          <li>
                            Look into government co-contribution opportunities
                          </li>
                          <li>
                            Regularly review and adjust your contributions as
                            your income grows
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                      ...
                      <div className='text-blue-700 text-sm space-y-1'>
                        <p>
                          ...
                          {formData.risk_tolerance} - Your projected return rate
                          is {calculatorInputs.annualReturnRate}%
                        </p>
                        <p>
                          <strong>Investment Experience:</strong>{" "}
                          {formData.investment_experience_level} - Consider
                        ...
                        <p>
                          ...
                          {calculatorInputs.retirementAge -
                            calculatorInputs.currentAge}{" "}
                          years - Time is your biggest advantage
                        </p>
                        {formData.number_of_dependents > 0 && (
                          <p>
                            <strong>Dependents:</strong>{" "}
                            {formData.number_of_dependents} - Consider life
              ...
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <Select
                      value={formData.investment_experience_level}
                      onValueChange={(value) =>
                ...
                <div className='space-y-6 border-t pt-6'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <Select
                        value={formData.home_ownership_status}
                        onValueChange={(value) =>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        <SelectContent className='bg-white'>
                          ...
                          <SelectItem value='Defined Benefit'>
                            Defined Benefit
                          </SelectItem>
