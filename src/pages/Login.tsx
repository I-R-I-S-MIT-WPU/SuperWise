  ...
  const features = [
    {
      ...
      description:
        "Get accurate projections and retirement income calculations.",
    },
    {
          ...
          <div className='flex justify-between items-center h-14'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <Button
                ...
                className='flex items-center text-sm px-4 py-2 h-9'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 h-full'>
          ...
          <div className='flex flex-col justify-center space-y-4'>
            ...
            <p className='text-base text-gray-600'>
              SuperWise helps you plan for retirement with confidence. Our
              AI-powered platform provides personalized advice to help you make
            ...
            <div className='space-y-4'>
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Get accurate retirement projections based on your unique
                    financial situation.
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Understand your risk tolerance and optimize your investment
                    strategy.
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    See how your retirement savings compare to others in your
                    demographic.
                  </p>
                </div>
              </div>
            ...
            <div className='space-y-3'>
              ...
              <div className='grid grid-cols-3 gap-3'>
                {features.map((feature, index) => (
                  <Card
                    key={index}
                    className='border-0 shadow-md hover:shadow-lg transition-shadow duration-200 bg-white/80'>
